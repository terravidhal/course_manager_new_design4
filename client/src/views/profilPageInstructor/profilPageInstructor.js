...
import './profilPageInstructor.css';


const ProfilPageInstructor = (props) => {
...
const handleChange = (e)=>{
    ...
    [e.target.name]: e.target.value 
     ...
     useEffect(() => {
      axios
        ...
        .then((res) => {
          console.log("u++++++++++res.data.oneSingleInstructor", res.data.oneSingleInstructor);
          setInfos({
            name: res.data.oneSingleInstructor.name ,
            image: res.data.oneSingleInstructor.image ,
            role: res.data.oneSingleInstructor.role ,
  ...
  const updateUser = (e) =>{
    e.preventDefault();
    axios.patch('http://localhost:8000/api/me/instructors/'+ id,
    user,
    {
    ...
    .then(res =>{
      ...
      setConfirmReg("sucefully , updating", "instructors");
      setErrs({});
  ...
  const updateImageProfile = async (e) => {
    ...
    axios.patch('http://localhost:8000/api/upload-image/instructors/'+ id,
    formdata,
    {
      withCredentials: true,
    })
  ...
  return(
    <div class="recentOrders">
        ...
        <div className="ProfilPageInstructor">
...
export default ProfilPageInstructor;
